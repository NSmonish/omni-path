...
def process_synthetic_video(video_path='input_match.mp4'):
    ...
    print("🚀 STARTING CONTINUOUS TACTICAL STREAM...")
            ...
            for i, cnt in enumerate(contours):
                ...
                if M["m00"] > 0:
                    ...
                    processor.push_coordinate(
                        ...
                        x=mx, y=my, heading=float(frame_count % 360)
                    )
            
            # Persist every 10 frames for FASTER feedback
            if frame_count % 10 == 0:
                processor.persist_to_db()
        
        cap.release()
        print("🔁 Video Loop Reset: Restarting Match Sequence...")
